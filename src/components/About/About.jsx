                ...
                <div className="about-container">
                    <div className='about-us-info'>
                        ...
                        <div className="about-bottom-right">
                            ...
                            <span className='about-sub-heading'>"Established in 2020"</span>
                            <p>Greetings to our gaming haven, where passion meets pixels! Since 2020, our digital realm was conceived from a shared love for immersive gaming experiences and cutting-edge technology. Our journey began with a vision to create a space where gamers of all levels could find their perfect match. From high-powered rigs to retro classics, we curate a diverse collection that caters to every gaming palate. Fueled by a relentless dedication to quality and innovation, our site is more than just a store - it is a virtual realm where gamers unite. Join us on this epic adventure, where every click tells a story.</p>
                        </div>
                    </div>
